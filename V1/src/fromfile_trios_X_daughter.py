def FromFile_Trios_Daughter_X(PATH="Markers/APOAI1.txt", nSim=100,seed=7644774):
    # ####################################################
    # 1
...
#FromFile_Trios_Daughter_X(PATH="Markers/DXS8378.txt", nSim=100000,seed=7644774)