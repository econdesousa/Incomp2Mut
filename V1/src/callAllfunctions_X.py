...
for fileName in finalList:
    ...
    ForcedMut_Duos_MotherSon_X(PATH=file2Work,nMut=NumbMutations,nSim=NumbSymulations,seed=int(rd.uniform(0,1)*10000000))
    ...
    #FromFile_Duos_MotherSon_X(PATH=file2Work,nSim=NumbSymulations,seed=int(rd.uniform(0,1)*10000000))
