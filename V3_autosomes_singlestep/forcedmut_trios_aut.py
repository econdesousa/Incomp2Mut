def ForcedMut_Trios_Aut(PATH="Markers/APOAI1.txt", nMutMale=1, nMutFemale=1, rThresh=0.5, nSim=100, seed=7644774):
    # ####################################################
    # 1
    ...
    file_path, outFile1, outFile2, outFile3 = outFileName(save2File, "ForcedMut_Trios_Aut_nMut_"+str(nMutMale)+"_"+str(nMutFemale), fp=PATH)
