...
RandomThresh=1  # 0: all muts on Male
...
for fileName in finalList:
    ...
    ForcedMut_Duos_Aut(PATH=file2Work, nMutMale=NumbMutationsMale, nMutFemale=NumbMutationsFemale, rThresh=RandomThresh, nSim=NumbSymulations,seed=int(rd.uniform(0,1)*10000000))