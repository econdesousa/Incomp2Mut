def ForcedMut_Trios_Daughter_X(PATH="Markers/APOAI1.txt", nMutMale=1, nMutFemale=1, rThresh=0.5, nSim=100,seed=7644774):
    # ####################################################
    # 1
    ...
    file_path, outFile1, outFile2, outFile3 = outFileName(save2File, "ForcedMut_Trios_Daughter_X_nMut_"+str(nMutMale)+"_"+str(nMutFemale),fp=PATH)
    ...
    for loop in range(nSim):
        ...
        distFatherMother = countincomp_v2(child, father,mother)  # vector of size 8x2
