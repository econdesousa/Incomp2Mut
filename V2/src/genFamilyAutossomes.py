...
# 3.2b X chromossome and female child
def genFamiliesXdaughter_v2(alleles, frequencies, mutStepMale, mutStepFemale, rThresh):
    father = choices(alleles, frequencies, k=1)  # father has one allele
    mother = choices(alleles, frequencies, k=2)
...
# 3.3 X chromossome and male child
...
# 3.3b X chromossome and male child
def genFamiliesXson_v2(alleles, frequencies, mutStepFemale=1):
    father = choices(alleles, frequencies, k=1)  # father has one allele
    mother = choices(alleles, frequencies, k=2)
