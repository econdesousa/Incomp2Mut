def ForcedMut_Trios_Aut(PATH="Markers/APOAI1.txt",nMut=1,nSim=100,seed=7644774):
    # ####################################################
    # 1
    ...
    file_path, outFile1, outFile2, outFile3 = outFileName(save2File, "ForcedMut_Trios_Aut_nMut_"+str(nMut),fp=PATH)
    ...
    for loop in range(nSim):
        ...
        father, mother, child, mutation_step, index = genFamilies(alleles, frequencies, nMut)
