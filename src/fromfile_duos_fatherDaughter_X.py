def FromFile_Duos_FatherDaughter_X(PATH="Markers/APOAI1.txt",nSim=100,seed=7644774):
    # ####################################################
    # 1
    ...
    file_path, outFile1, outFile2, outFile3 = outFileName(save2File, "FromFile_Duos_FatherDaughter_X",fp=PATH)
...
#FromFile_Duos_FatherDaughter_X(PATH="Markers/APOAI1.txt")
