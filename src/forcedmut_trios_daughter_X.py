def ForcedMut_Trios_Daughter_X(PATH="Markers/APOAI1.txt",nMut=1,nSim=100,seed=7644774):
    # ####################################################
    # 1
    ...
    file_path, outFile1, outFile2, outFile3 = outFileName(save2File, "ForcedMut_Trios_Daughter_X_nMut_"+str(nMut),fp=PATH)
