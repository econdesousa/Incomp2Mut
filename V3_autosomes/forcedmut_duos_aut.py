def ForcedMut_Duos_Aut(PATH="Markers/APOAI1.txt", nMut=1, nSim=100, seed=7644774):
    ...
    file_path, outFile1, outFile2, outFile3 = outFileName(save2File, "ForcedMut_Duos_Aut_nMut_"+str(nMut), fp=PATH)
